...
func (s *DirectorOrganizationService) List() (*DirectorOrganizationListResponse, error) {
	resp, err := s.client.get("/mgmt/organization")
	if err != nil {
...
func (s *DirectorOrganizationService) Get(id string) (*DirectorOrganization, error) {
	resp, err := s.client.get("/mgmt/organization" + "/" + id)
	if err != nil {
