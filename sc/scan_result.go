...
func (s *ScanResultService) List() (*ScanResultListResponse, error) {
	resp, err := s.client.get("/scanResult")
	if err != nil {
...
func (s *ScanResultService) Get(id string) (*ScanResult, error) {
	resp, err := s.client.get("/scanResult/" + id)
	if err != nil {
...
func (s *ScanResultService) Delete(id string) error {
	_, err := s.client.delete("/scanResult/" + id)
	if err != nil {
...
func (s *ScanResultService) Copy(id string, input *ScanResultCopyInput) error {
	_, err := s.client.post("/scanResult/"+id+"/copy", input)
	if err != nil {
...
func (s *ScanResultService) Email(id string, input *ScanResultEmailInput) error {
	_, err := s.client.post("/scanResult/"+id+"/email", input)
	if err != nil {
...
func (s *ScanResultService) Import(input *ScanResultImportInput) (*ScanResult, error) {
	resp, err := s.client.post("/scanResult/import", input)
	if err != nil {
...
func (s *ScanResultService) Reimport(id string, input *ScanResultReimportInput) (*ScanResult, error) {
	resp, err := s.client.post("/scanResult/"+id+"/import", input)
	if err != nil {
...
func (s *ScanResultService) Stop(id string) (*ScanResult, error) {
	resp, err := s.client.post("/scanResult/"+id+"/stop", nil)
	if err != nil {
...
func (s *ScanResultService) Pause(id string) (*ScanResult, error) {
	resp, err := s.client.post("/scanResult/"+id+"/pause", nil)
	if err != nil {
...
func (s *ScanResultService) Resume(id string) (*ScanResult, error) {
	resp, err := s.client.post("/scanResult/"+id+"/resume", nil)
	if err != nil {
...
func (s *ScanResultService) Download(id string, input *ScanResultDownloadInput) error {
	_, err := s.client.post("/scanResult/"+id+"/download", input)
	if err != nil {
